...
Users/shekhar_icd/src/model/

# python convert_to_fp16.py --model_path "../model/e5-large-v2-20250604214304-finetuned-icd-v40/" --output_path "../model/e5_v40_half" --use_sentence_transformer
