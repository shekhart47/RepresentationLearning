    ...
    def similarity_based_selection(self, 
        ...
        Args:
            ...
            similarity_threshold (float): Threshold above which queries are considered similar.
                                         ...
                                         i.e. if threshold is 0.95, then all quries upto CS of 0.95 are considered unique 
                                         and above that range are considered similar
                                         To have stricter values, set lower threshold
